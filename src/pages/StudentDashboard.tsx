...
import { Play, TrendingUp, Users, Target, BookOpen, BrainCircuit, Activity, Flame, ArrowLeft, CheckCircle2, XCircle, ArrowRight, Loader2, Trophy, Sparkles, Maximize2, Minimize2, Bell, BellOff, BellRing, Settings, AlertTriangle, Trash2, Snowflake, Volume2, VolumeX, Clock, Network } from "lucide-react";
...
// Removed unused state
  ...
  useEffect(() => {
    ...
    let unsubscribe = () => {};
    try {
      unsubscribe = onSnapshot(collection(db, "users", user.id, "cardsState"), (snapshot) => {
        const states: any[] = [];
        snapshot.forEach((docSnap) => {
...
// Removed Achievement Tab Button
      ...
      <AnimatePresence mode="wait">
// Removed achievement tab rendering
      ...
      {activeTab === "study" && (
        ...
        >
          <section className="md:col-span-2 space-y-6">
            ...
            <DeckList decks={decks.slice(0, 4)} />
